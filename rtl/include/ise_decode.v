...
wire dec_invalid_opcode = !(dec_aesmix_enc || dec_gpr2xcr || dec_madd_3 || dec_gather_h || dec_str_w || dec_macc_2 || dec_sha3_x1 || dec_sha3_yx || dec_cmov_f || dec_sha3_x4 || dec_scatter_b || dec_mequ || dec_gather_b || dec_msll || dec_msll_i || dec_mlte || dec_mclmul_3 || dec_ipbit || dec_init || dec_psll || dec_ldr_hu || dec_msrl_i || dec_ld_bu || dec_st_h || dec_msrl || dec_ld_liu || dec_mgte || dec_st_w || dec_macc_1 || dec_str_b || dec_bop || dec_pbit || dec_ld_hiu || dec_prot || dec_psrl_i || dec_pclmul_h || dec_cmov_t || dec_ldr_bu || dec_pmul_l || dec_pclmul_l || dec_pbyte || dec_st_b || dec_psrl || dec_aessub_encrot || dec_ld_hu || dec_aesmix_dec || dec_rngtest || dec_ldr_w || dec_psub || dec_msub_3 || dec_psll_i || dec_rngsamp || dec_madd_2 || dec_pmul_h || dec_aessub_dec || dec_aessub_enc || dec_sha3_x2 || dec_ld_w || dec_bmv || dec_rngseed || dec_prot_i || dec_msub_2 || dec_sha3_xy || dec_scatter_h || dec_ins || dec_str_h || dec_ext || dec_aessub_decrot || dec_mmul_3 || dec_padd || dec_xcr2gpr || dec_lut);
